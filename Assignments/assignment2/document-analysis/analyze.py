...
# IMPORTANT:
# run the file with: `python2.7 analyze.py test.txt`
...
def parseForLSVD(ls): #letters, sentences, vowels, and dipthongs
    ...
    for word in ls:
        ...
        for letter in word.lower():
            ...
            if letter.isalpha(): # is the character a letter?
                letters += 1
        if vowels_in_word > 1 and word.endswith('e'): #if word has more than 1 vowel and ends in 'e'
